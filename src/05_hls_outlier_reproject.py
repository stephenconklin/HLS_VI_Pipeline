...
logger = setup_logging("05_outlier_reproject")
...
def main():
    logger.info(f"Step 05: Outlier Extraction + Reproject to {TARGET_CRS}")
    ...
    logger.info(f"Step 05 complete. Processed {total} work item(s).")
